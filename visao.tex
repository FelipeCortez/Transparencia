...
\begin{document}
    ...
    \begin{titlepage}
        \huge
        \flushright{Sistema de Transparência Pública para a Assembleia
        Legislativa do RN}
    \end{titlepage}
    ...
    \section{Introdução}
        ...
        % TODO: Colocar diagramas de contexto

        \subsection{Definições, acrônimos e abreviações}
        % TODO: Não se aplicam até agora

        \subsection{Referências}
        % TODO: Este documento poderá ser complementado ao ter em mãos os
